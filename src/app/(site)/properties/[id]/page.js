    ...
    >
      ...
      <div className="relative mt-20 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          ...
          {/* ===== IMAGE GALLERY – no framer-motion, pure CSS transitions ===== */}
          {hasSingleImage ? (
            <div className="max-w-4xl mx-auto">
              <div className="relative group">
                <div
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-3">
              ...
              <div className="md:col-span-9 lg:col-span-8 relative group">
                <div
                  ...
                  onClick={() => setShowLightbox(true)}
                >
                  {/* Image with CSS transition – key change triggers opacity */}
                  <div
                    key={activeImage}
      ...
      {/* ===== LIGHTBOX – no framer-motion, pure CSS ===== */}
      {showLightbox && (
        <div
          className="fixed inset-0 z-2000 bg-black/95 flex items-center justify-center transition-opacity duration-300 ease-in-out"
          style={{ opacity: 1 }}
          onClick={() => setShowLightbox(false)}
        >
          <button
          ...
          >
            <div
              key={activeImage}
              className="relative max-w-5xl max-h-[80vh] w-full aspect-video transition-all duration-300 ease-in-out"
